...
class ProgramModel(BaseModel):
    ...
    previous_id: str = Field(...,title="Previous ProgramID", description="Used to track and restore changes")

class SearchEligibility(BaseModel):
    eligibility: list[str] = Field([''], title="Eligibility", description="Eligibility criteria with option for new criteria")
